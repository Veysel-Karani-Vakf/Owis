...
const cityItem: PageFieldDef[] = [
  ...
  { path: 'period', label: L('فترة التدريب', 'Eğitim dönemi', 'Training period'), type: 'text' },
  { path: 'organizations', label: L('المنظمات المشاركة', 'Katılımcı kuruluşlar', 'Participating organizations'), type: 'text' },
  { path: 'patron', label: L('الرعاية أو الإشراف', 'Himaye veya gözetim', 'Sponsorship or supervision'), type: 'text' },
