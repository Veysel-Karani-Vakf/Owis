...
/** Chapter 10 — رواد اليمن: the flagship, with the philosophy chain as its beat. */
  ...
  return (
    <Chapter id="profile-pioneers" className="profile-stage--soft overflow-hidden py-20 md:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-8">
        <SectionHeading index={10} eyebrow={content.meta.title} heading={pioneers.heading} subheading={pioneers.subheading} className="mb-12" />
