...
export const localizedDonateCheckout: Record<Locale, DonateCheckoutContent> = {
  ar: {
    ...
    amount: {
      ...
      currencyNote: 'تتم معالجة المساهمات بالليرة التركية (TRY).',
    },
    donor: {
  ...
  tr: {
    ...
    amount: {
      ...
      currencyNote: 'Katkilar Turk Lirasi (TRY) olarak islenir.',
    },
    donor: {
      heading: 'Bagisci Bilgileri',
      nameLabel: 'Ad Soyad',
      emailLabel: 'E-posta',
      phoneLabel: 'Telefon',
  ...
  en: {
    ...
    amount: {
      ...
      currencyNote: 'Contributions are processed in Turkish Lira (TRY).',
    },
    donor: {
